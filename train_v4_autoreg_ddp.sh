#!/bin/bash
# 4-GPU DDP training for CRR-Flow V4 with autoregressive conditioning
# Effective batch size: 4 GPUs × 64 = 256, K=20 history, L=180 target
#
# Usage: bash train_v4_autoreg_ddp.sh
...
torchrun --nproc_per_node=4 --master_port=29500 \
  ...
  --save_dir save/v4_autoreg_release_ddp_200k \
  --save_interval 10000 \
  --log_interval 500 \
  --autoregressive \
  --history_len 20 \
