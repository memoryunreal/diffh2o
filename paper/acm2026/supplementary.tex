...
\begin{table*}[t]
  ...
  \begin{tabular}{@{}lccccccc@{}}
    ...
    \midrule
    HOIDiff & \textbf{1.077} & \underline{0.320} & \underline{0.525} & \underline{0.652} & \underline{4.457} & 10.44 \\
    HIMO & \underline{2.131} & \textbf{0.352} & \textbf{0.557} & \textbf{0.670} & \textbf{4.251} & 11.45 \\
    PriorMDM & 3.160 & 0.266 & 0.463 & 0.570 & 4.908 & 10.39 \\
    CRR-Flow (Ours) & 3.467 & 0.186 & 0.309 & 0.416 & 6.202 & \underline{11.37} \\
...
\begin{table*}[t]
  ...
  \begin{tabular}{@{}lccccccc@{}}
    ...
    \midrule
    HIMO & \textbf{2.571} & \textbf{0.275} & \textbf{0.438} & \textbf{0.569} & \textbf{4.348} & 8.78 \\
    HOIDiff & \underline{2.906} & \underline{0.269} & \underline{0.412} & \underline{0.550} & \underline{4.509} & 8.81 \\
    CRR-Flow (Ours) & 3.149 & 0.144 & 0.250 & 0.325 & 6.425 & \underline{9.12} \\
